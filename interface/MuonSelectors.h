...
namespace muon {
   ...
   bool isTightMuonWithBS(const reco::Muon&, const reco::BeamSpot&);
   bool isSoftMuonWithBS(const reco::Muon&, const reco::BeamSpot&);
   bool isHighPtMuonWithBS(const reco::Muon&, const reco::BeamSpot&);
